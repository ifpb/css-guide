...
#### [`<table bgcolor="">`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/table#attr-bgcolor)

```html
<table bgcolor="grey" border="1" cellspacing="0">
  <tr>
    <td> Item 1.1</td>
    <td> Item 1.2</td>
  </tr>
...
[inheritance/not-inheritance.html](inheritance/index.html):
```html
<!DOCTYPE html>
<html lang="en">
<head>
